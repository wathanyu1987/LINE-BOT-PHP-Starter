...
if($arrJson['events'][0]['message']['text'] == "สวัสดี"){
  ...
  $arrPostData['replyToken'] = $arrJson['events'][0]['replyToken'];
  $arrPostData['messages'][0]['type'] = "text";
  $arrPostData['messages'][0]['text'] = "DNI-1317 = 2";
  ...
  $arrPostData['replyToken'] = $arrJson['events'][0]['replyToken'];
  $arrPostData['messages'][0]['type'] = "text";
  $arrPostData['messages'][0]['text'] = "DNI-1856 = 5";
  ...
  $arrPostData['replyToken'] = $arrJson['events'][0]['replyToken'];
  $arrPostData['messages'][0]['type'] = "text";
  $arrPostData['messages'][0]['text'] = "DNI-1989 = ไม่มีของ";
  ...
  $arrPostData['replyToken'] = $arrJson['events'][0]['replyToken'];
  $arrPostData['messages'][0]['type'] = "text";
  $arrPostData['messages'][0]['text'] = "DNI-303 = ไม่มีของ";
  ...
  $arrPostData['replyToken'] = $arrJson['events'][0]['replyToken'];
  $arrPostData['messages'][0]['type'] = "text";
  $arrPostData['messages'][0]['text'] = "DNI-498 = 8";
  ...
  $arrPostData['replyToken'] = $arrJson['events'][0]['replyToken'];
  $arrPostData['messages'][0]['type'] = "text";
  $arrPostData['messages'][0]['text'] = "SERVER : ONLINE กรณีใช้บนไลน์ PC จำเป็นต้องอนุมัติในสมาร์ทโฟนก่อนครับ ขออภัยในความไม่สะดวก";
}else if($arrJson['events'][0]['message']['text'] == "ทำอะไรได้บ้าง"){
  $arrPostData = array();
  $arrPostData['replyToken'] = $arrJson['events'][0]['replyToken'];
  $arrPostData['messages'][0]['type'] = "text";
  $arrPostData['messages'][0]['text'] = "เช็คสต็อก DNI";
}else if($arrJson['events'][0]['message']['text'] == "ชื่ออะไร"){
  $arrPostData = array();
  $arrPostData['replyToken'] = $arrJson['events'][0]['replyToken'];
  $arrPostData['messages'][0]['type'] = "text";
  $arrPostData['messages'][0]['text'] = "ชื่อ Last Project ครับ";
}else if($arrJson['events'][0]['message']['text'] == "INFO"){
  $arrPostData = array();
  $arrPostData['replyToken'] = $arrJson['events'][0]['replyToken'];
  $arrPostData['messages'][0]['type'] = "text";
  $arrPostData['messages'][0]['text'] = "สร้าง และบริหารจัดการโดย The Last Project เวอร์ชั่น เบต้า C";
}else if($arrJson['events'][0]['message']['text'] == "Help"){
  $arrPostData = array();
  $arrPostData['replyToken'] = $arrJson['events'][0]['replyToken'];
  $arrPostData['messages'][0]['type'] = "text";
  $arrPostData['messages'][0]['text'] = "วิธีเช็คสต็อก DNI พิมพ์ DNI-ตามด้วยเบอร์ที่ต้องการ ตัวอักษรพิมพ์ใหญ่ ต้องมีเครื่องหมาย - และห้ามเว้นวรรค  ตัวอย่างDNI-248 และสามารถเช็คได้ครั้งละ1เบอร์เท่านั้น หากต้องการเช็คเบอร์อื่นเพิ่มเติมกรุณาส่งเข้ามาใหม่";
}else if($arrJson['events'][0]['message']['text'] == "LPADMINCM"){
  $arrPostData = array();
  $arrPostData['replyToken'] = $arrJson['events'][0]['replyToken'];
  $arrPostData['messages'][0]['type'] = "text";
  $arrPostData['messages'][0]['text'] = "STATUS/ชื่ออะไร/ทำอะไรได้บ้าง/INFO/Help/คู่มือ/สวัสดี";
  ...
  $arrPostData['replyToken'] = $arrJson['events'][0]['replyToken'];
  $arrPostData['messages'][0]['type'] = "text";
  $arrPostData['messages'][0]['text'] = "ฉันไม่เข้าใจคำสั่ง พิมพ์ Help หรือ คู่มือ เพื่อดูวิธีการใช้งาน";
}
